...
def parse_args():
    ...
    parser.add_argument('--test-file', type=str, default = '../../data/qblink_test_graph.json')
    parser.add_argument("--bert_model", default="bert-base-uncased", type=str)
    parser.add_argument('--save-model', type=str, default='../../experiments/qblink_delft_bert.pt')
    parser.add_argument('--load-model', type=str, default='../../experiments/qblink_delft_bert.pt')
    ...
    parser.add_argument('--log-file', type=str, default = '../../experiments/qblink_bert.log')
