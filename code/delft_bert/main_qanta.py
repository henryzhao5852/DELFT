...
def parse_args():
    ...
    parser.add_argument("--train-file", type=str, default='../../data/qanta_train_graph.json')
    parser.add_argument("--dev-file", type=str, default='../../data/qanta_dev_graph.json')
    parser.add_argument('--test-file', type=str, default = '../../data/qanta_test_graph.json')
    parser.add_argument("--bert_model", default="bert-base-uncased", type=str)
    parser.add_argument('--save-model', type=str, default='../../experiments/qanta_delft_bert.pt')
    parser.add_argument('--load-model', type=str, default='../../experiments/qanta_delft_bert.pt')
    ...
    parser.add_argument('--log-file', type=str, default = '../../experiments/qanta_bert.log')
...
if __name__ == "__main__":
    ...
    if args.test:
        ...
        dev_dataset = QANTADataset(test_graph, args, tokenizer, False)
    ...
    model.device = device 
    tokenizer = BertTokenizer.from_pretrained(args.bert_model)
    train_dataset = QANTADataset(train_graph, args, tokenizer, True)
    dev_dataset = QANTADataset(dev_graph, args, tokenizer, False)
