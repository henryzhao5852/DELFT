...
def parse_args():
    ...
    parser.add_argument("--train-file", type=str, default='../../data/qblink_tokenized_train_graph.json')
    parser.add_argument("--dev-file", type=str, default='../../data/qblink_tokenized_dev_graph.json')
    parser.add_argument('--test-file', type=str, default = '../../data/qblink_tokenized_test_graph.json')

    parser.add_argument('--save-model', type=str, default='../../experiments/qblink_delft_glove.pt')
    parser.add_argument('--load-model', type=str, default='../../experiments/qblink_delft_glove.pt')
    ...
    parser.add_argument('--log-file', type=str, default = '../../experiments/qblink_glove.log')
...
if __name__ == "__main__":
    ...
    dev_dataset = QBLINKDataset(dev_graph, model, False)
