...
def parse_args():
    ...
    parser.add_argument("--train-file", type=str, default='../../data/qanta_tokenized_train_graph.json')
    parser.add_argument("--dev-file", type=str, default='../../data/qanta_tokenized_dev_graph.json')
    parser.add_argument('--test-file', type=str, default = '../../data/qanta_tokenized_test_graph.json')

    parser.add_argument('--save-model', type=str, default='../../experiments/qanta_delft_glove.pt')
    parser.add_argument('--load-model', type=str, default='../../experiments/qanta_delft_glove.pt')
...
if __name__ == "__main__":
    ...
    if args.test:
        ...
        dev_dataset = QANTADataset(test_graph, model, False)
    ...
    train_dataset = QANTADataset(train_graph, model, True)
    dev_dataset = QANTADataset(dev_graph, model, False)
